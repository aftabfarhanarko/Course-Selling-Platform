  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-20">
      ...
      <section className="bg-white border-b border-slate-200 overflow-hidden relative">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-slate-200/50 relative">
            ...
            <h3 className="text-lg font-bold tracking-tight mb-6 relative z-10">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 lg:grid-cols-4 divide-x divide-y lg:divide-y-0 divide-slate-100">
          {stats.map((s) => (
            <div
              key={s.label}
              className="p-8 sm:p-10 text-center hover:bg-slate-50 transition-colors"
            >
              <div className="text-3xl sm:text-4xl font-black text-blue-600 tracking-tight mb-2">
                {s.value}
              </div>
      ...
      <section className="py-20 max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-1 bg-slate-200 border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
          {steps.map((s) => (
            <div
              key={s.num}
              className="bg-white p-8 sm:p-10 hover:bg-slate-50 transition-colors group"
            >
              <div className="text-5xl font-black text-slate-100 group-hover:text-blue-50 transition-colors tracking-tighter mb-6">
                {s.num}
              </div>
      ...
      <section className="py-20 bg-white border-y border-slate-200">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-blue-600 mb-3">
              <div className="w-4 h-0.5 bg-blue-600 rounded-full" /> Commission
              Tiers
            </div>
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center">
            {tiers.map((t) => (
              <div
                key={t.name}
                className={`relative bg-white rounded-3xl p-8 sm:p-10 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${
                  t.featured
              ...
              >
                ...
                <div className="text-5xl sm:text-6xl font-black text-blue-600 tracking-tight mb-2">
                  {t.pct}
                </div>
                <div className="text-sm font-semibold text-slate-400 mb-6">
                  {t.range}
                </div>

                <h3 className="text-xl font-bold pb-6 border-b border-slate-100 mb-6">
                  {t.name}
                </h3>
      ...
      <section className="py-20 max-w-[1200px] mx-auto px-4 sm:px-6">
        <div className="mb-12">
          <div className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-blue-600 mb-3">
            <div className="w-4 h-0.5 bg-blue-600 rounded-full" /> Partner
            Stories
          </div>
          ...
          {faqs.map((f, i) => {
            ...
            return (
              <div key={i} className="py-2">
                ...
                >
                  <span
                    className={`font-bold transition-colors ${isOpen ? "text-blue-600" : "text-slate-900 group-hover:text-blue-600"}`}
                  >
                    {f.q}
                  </span>
                  <div

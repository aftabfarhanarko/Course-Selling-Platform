...
export default function SuccessPage() {
  ...
  className="w-full sm:w-auto">
                     <button className="w-full sm:w-auto px-6  py-3 rounded-full bg-blue-600 text-white font-medium shadow-md hover:scale-[1.02] transition">
                      ...
                      <button className="w-full sm:w-auto px-6 md:mt-2 py-3 rounded-full bg-blue-100 text-blue-700 font-medium hover:bg-blue-200 transition flex items-center justify-center gap-2">

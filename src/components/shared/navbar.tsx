    ...
    >
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <Link href="/login">
              <Button
                variant="outline"
                size="sm"
                className="border-gray-400 text-gray-700 hover:bg-white"
              >
                Login
              </Button>
            </Link>
          ...
          {/* Profile Icon */}
          <button className="ml-4 inline-flex items-center justify-center rounded-full bg-gray-300 h-9 w-9 text-gray-600 hover:bg-gray-400 transition-colors">
